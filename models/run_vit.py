...
if __name__ == "__main__":
    ...
    output_dir = f"./vit_runs/vit_{num_epochs}.pth"
    ...
    # train_metrics_df.to_csv(f"vit_{num_epochs}_train_metrics.csv", index=False)
    # val_metrics_df.to_csv(f"vit_{num_epochs}_val_metrics.csv", index=False)

    # # Plot the metrics and save
    # train_loss_dir = f"./vit_runs/figures/train_loss_vit_{num_epochs}"
    # plot_figures(train_loss_dir, num_epochs, train_losses, "train", "loss")
    # val_loss_dir  = f"./vit_runs/figures/val_loss_vit_{num_epochs}"
    # plot_figures(val_loss_dir, num_epochs // 10, val_losses, "val", "loss")

    # train_accs_dir = f"./vit_runs/figures/train_accs_vit_{num_epochs}"
    # plot_figures(train_accs_dir, num_epochs, train_accs, "train", "acc")
    # val_accs_dir = f"./vit_runs/figures/val_accs_vit_{num_epochs}"
    # plot_figures(val_accs_dir, num_epochs // 10, val_accs, "val", "acc")

    
    model_dir = "./vit_runs/vit_200.pth"
    save_path = "./vit_tracked_examples_on_test"
    ...
    # generate_confusion_matrix(model, test_loader, device, output_dir, normalize=True):
    cm_save_path = "./vit_cm"
